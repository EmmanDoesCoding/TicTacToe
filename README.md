...
• Choose your symbol (X or O) <br>
• Randomized AI moves <br>
...
• Python 3 <br>
• Random module for AI move selection <br>
• Time module for smooth transitio <br>
• IPython.display.clear_output for screen clearing (best used in Jupyter Notebook / Google Colab)
